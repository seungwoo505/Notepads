...
function Create(props){
	...
	useEffect(() => {
  	...
  	const save_canvas = () =>{
    	...
    	fetch("/php/postDataWithFile.php",
    	{
      		method: "POST",
      		body: JSON.stringify({
        		title: title,
	...
	return(
		<div id = "notepad">
			<input type="text" placeholder="제목" maxlength="20" id = "title" onChange={(e) => setTitle(e.target.value)}/>
			<input type="password" placeholder="비밀번호" id = "password" onChange={(e) => setPassword(e.target.value)}/>
			<button id = "save" onClick={save_canvas}>
				저장
			</button>
